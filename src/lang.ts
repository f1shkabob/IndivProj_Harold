...
export type Pair = { tag: 'pair', e1: Exp, e2: Exp} 
export const pair = (e1: Exp, e2: Exp): Exp => ({tag: 'pair', e1, e2})

export type PairVal = {tag: 'pairVal', v1: Value, v2: Value}
export const pairVal = (v1: Value, v2: Value): Value => ({tag: 'pairVal', v1, v2})

export type Exp = Num | Bool | Not | Plus | Eq | And | Or | If | Unit | Pair
...
export type PairTyp = {tag: 'pairTyp', t1: Typ, t2: Typ}
export const pairTyp = (t1: Typ, t2: Typ): Typ => ({ tag: 'pairTyp', t1, t2})

export type Typ = TyNat | TyBool | Unit | Pair | PairTyp
